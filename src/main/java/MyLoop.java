public class MyLoop {
	...
	public static int fibonacci(int n) {
		// Határozza meg a fibonacci sorozat n. értékét. Egynél kisebb érték esetén térjen vissza 0-val.
		return 0;
	}
	...
	public static int meghatarozOsztokOsszege(int n) {
		...
		//// Határozza meg a paraméterben kapott szám osztóinak összegét. Ha a szám egynél kisebb térjen vissza -1-el.
		return 0;
	}
	...
	public static void main(final String[] args) {
		...
		//System.out.println("Lnko(84,18): "+lnko(84,18));
		//System.out.println("Osztók összege 18 "+ meghatarozOsztokOsszege(18));
		//System.out.println("Tökéletes-e:"+tokeletesE(28));
	}
}
